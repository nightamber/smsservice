 ...
 *
 * <p>备注:Demo工程编码采用UTF-8 国际短信发送请勿参照此DEMO
 */
@Component
public class SmsUtil {
  ...
  //    static final String accessKeyId = "LTAIYPm0UG6Yn4Jr";
  //    static final String accessKeySecret = "8PrfYoak73VCyATfDSYpZPJAdZPgMr";
